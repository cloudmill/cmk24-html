...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./main */ \"./app/scripts/main.js\");\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/js/swiper.esm.bundle.js\");\n/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! inputmask */ \"./node_modules/inputmask/index.js\");\n/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(inputmask__WEBPACK_IMPORTED_MODULE_3__);\n\n\n\n\njquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {\n  // HEADER\n  headerScroll();\n  anchor();\n  burger();\n  cllick();\n  tooltip(); // SLIDERS\n\n  slider(); // MODALS\n\n  modal();\n  mask(); //formWarn ();\n\n  formId();\n});\n\nvar headerScroll = function headerScroll() {\n  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() > 0) {\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').addClass('header--scroll');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__logo').css('display', 'none');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__logo--scroll').css('display', 'block');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__phone').addClass('header__phone--scroll');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button--header').addClass('button--header--scroll');\n  }\n\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll', function () {\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').addClass('header--scroll');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__logo').css('display', 'none');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__logo--scroll').css('display', 'block');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__phone').addClass('header__phone--scroll');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button--header').addClass('button--blue button--blue--header-size');\n\n    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').hasClass('noneScroll') !== true && jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() !== 0) {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').addClass('burger--scroll');\n    }\n\n    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() == 0) {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').removeClass('header--scroll');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__logo').css('display', 'block');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__logo--scroll').css('display', 'none');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__phone').removeClass('header__phone--scroll');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button--header').removeClass('button--blue button--blue--header-size');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').removeClass('burger--scroll');\n    }\n  });\n};\n\nfunction slider() {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".slider-block\").each(function () {\n    var slider = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find(\".swiper-container\"),\n        buttons = {\n      left: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find(\".button--left\"),\n      right: jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find(\".button--right\")\n    },\n        swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__[\"default\"](slider[0], {\n      slidesPerGroup: 1,\n      slidesPerView: 'auto',\n      spaceBetween: 20,\n      navigation: {\n        nextEl: buttons.right[0],\n        prevEl: buttons.left[0]\n      }\n    });\n  });\n}\n\nfunction burger() {\n  var counter = 0;\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').on('click', function () {\n    counter = counter + 1;\n    var height = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.start').innerHeight();\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').toggleClass('burger--active');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-menu').toggleClass('burger-menu--active').css('height', height);\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').toggleClass('header--burger');\n\n    if (counter % 2 == 1 && (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').hasClass('burger--scroll') || jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() == 0)) {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').removeClass('burger--scroll');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').addClass('noneScroll');\n    } else {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').removeClass('noneScroll');\n\n      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() !== 0) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').addClass('burger--scroll');\n      }\n    }\n  });\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-menu').on('click', 'a', function () {\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-menu').removeClass('burger-menu--active');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').removeClass('burger--active');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').removeClass('header--burger');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').removeClass('noneScroll');\n  });\n}\n\nfunction validateEmail(email) {\n  var re = /^(([^<>()[\\]\\\\.,;:\\s@\\\"]+(\\.[^<>()[\\]\\\\.,;:\\s@\\\"]+)*)|(\\\".+\\\"))@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\])|(([a-zA-Z\\-0-9]+\\.)+[a-zA-Z]{2,}))$/;\n  return re.test(email);\n}\n\nfunction modal(event) {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".js--modal\").on(\"click\", function () {\n    var modal = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr(\"href\");\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal\").addClass(\"modal--active\");\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(modal).addClass(\"modal__item--active\");\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal\").on(\"click\", function (event) {\n      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).hasClass(\"modal\") || jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).hasClass(\"svg-cross\") || jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).hasClass(\"modal__close\")) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal\").removeClass(\"modal--active\");\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal__item--active\").removeClass(\"modal__item--active\");\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__thanks').css('display', 'none');\n      }\n    });\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('keydown', function (event) {\n      if (event.keyCode == 27) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal\").removeClass(\"modal--active\");\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal__item--active\").removeClass(\"modal__item--active\");\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__thanks').css('display', 'none');\n      }\n\n      ;\n    });\n  }); // if (($('#chec').prop('checked') == true) || ($('#callcheck').prop('checked') == true)){\n  //   $('.modal-form__consent').removeClass('modal-form__consent--red');\n  //   $('.consent-checkbox').removeClass('consent-checkbox--red');\n  // }else{\n  //   $('.modal-form__consent').addClass('modal-form__consent--red');\n  //   $('.consent-checkbox').addClass('consent-checkbox--red');\n  // (($('#chec').prop('checked') && (( $('#callphone').val().length > 1) || ($('#email').val().length > 5) )) || ($('#callcheck').prop('checked') && (( $('#callphone').val().length > 1) || ($('#email').val().length > 5) )))\n  // var button = function(event){\n  //   event.preventDefault();\n  // };\n\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button--modal').on('click', function (event) {\n    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#chec').prop('checked') && jquery__WEBPACK_IMPORTED_MODULE_0___default()('#quest').val().length > 0 && validateEmail(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#email').val()) || jquery__WEBPACK_IMPORTED_MODULE_0___default()('#callcheck').prop('checked') && jquery__WEBPACK_IMPORTED_MODULE_0___default()('#callphone').val().length > 1 && jquery__WEBPACK_IMPORTED_MODULE_0___default()('#callname').val().length > 1) {\n      event.preventDefault();\n      var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents('[data-attr=modal_form]'),\n          name = form.find('input[name=name]').val(),\n          phone = form.find('input[name=call]').val(),\n          mail = form.find('input[name=e-mail]').val(),\n          question = form.find('textarea[name=question]').val(),\n          type = form.find('input[name=form-id]').val(),\n          url = form.find('input[name=url]').val(),\n          formData = new Object();\n\n      if (type == 'Форма: Узнать подробнее с первого экрана') {\n        formData = {\n          name: name,\n          phone: phone,\n          mail: mail,\n          question: question,\n          type: type,\n          url: url\n        };\n      } else {\n        formData = {\n          name: name,\n          phone: phone,\n          type: type,\n          url: url\n        };\n      }\n\n      ajaxForms(formData);\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__thanks').css('display', 'flex');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal').addClass('modal--active');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#thanks').addClass('modal__item--active');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#chec').prop('checked', false);\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#callcheck').prop('checked', false);\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.form__input').val('');\n    } else {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal-form__consent').addClass('modal-form__consent--red');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consent-checkbox').addClass('consent-checkbox--red');\n      event.preventDefault();\n    }\n\n    var mod = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent();\n    mod.find('.form__input').each(function () {\n      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() < 2) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('form__input--warn');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.text-warn').css('display', 'block');\n        event.preventDefault();\n      } else {\n        if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)[0].id === 'email' && !validateEmail(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val())) {\n          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('form__input--warn');\n          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).next('.text-warn').text('Неверно указан адрес почты').css('display', 'block');\n        } else {\n          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass('form__input--warn');\n          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.text-warn').css('display', 'none');\n        }\n      }\n    });\n\n    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('#chec').prop('checked') || jquery__WEBPACK_IMPORTED_MODULE_0___default()('#callcheck').prop('checked')) {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal-form__consent').removeClass('modal-form__consent--red');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consent-checkbox').removeClass('consent-checkbox--red');\n    } else {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal-form__consent').addClass('modal-form__consent--red');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consent-checkbox').addClass('consent-checkbox--red');\n      event.preventDefault();\n    }\n  });\n}\n\nfunction mask() {\n  inputmask__WEBPACK_IMPORTED_MODULE_3___default()({\n    mask: \"+7(999) 999-99-99\",\n    greedy: false,\n    autoUnmask: true,\n    clearIncomplete: true,\n    showMaskOnHover: false\n  }).mask(\"#callphone\");\n}\n\nfunction cllick() {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button').on('click', function (e) {\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).append('<div class = circle></div>');\n    var position = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).offset();\n    var topX = e.pageX - (position.left + 65);\n    var leftY = e.pageY - (position.top + 65);\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.circle').css({\n      'top': leftY + 'px',\n      'left': topX + 'px'\n    });\n  });\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button').on('mouseup', function () {\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.circle').remove();\n  });\n}\n\nfunction tooltip() {\n  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() >= 1000) {\n    var name;\n    var link;\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.link').on('mouseenter', function () {\n      name = '#tool-' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).addClass('tool-active');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.arrow').addClass('arrow-block');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.arrowl').addClass('arrow-block');\n    });\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.link').on('mouseleave', function () {\n      name = '#tool-' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).removeClass('tool-active');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.arrow').removeClass('arrow-block');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.arrowl').removeClass('arrow-block');\n    });\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.left').on('mouseenter', function () {\n      name = '#tool-' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).addClass('tool-activel');\n    });\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.left').on('mouseleave', function () {\n      name = '#tool-' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).removeClass('tool-activel');\n    });\n  } else {\n    var name;\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.link').on('click', function () {\n      if (name !== '#tool-' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id')) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).removeClass('tool-active');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).removeClass('tool-activel');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.arrow').removeClass('arrow-block');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.arrowl').removeClass('arrow-block');\n      }\n\n      name = '#tool-' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.arrow').toggleClass('arrow-block');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.arrowl').toggleClass('arrow-block');\n\n      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hasClass('left')) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).toggleClass('tool-activel');\n      } else {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).toggleClass('tool-active');\n      }\n    });\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('click', function (event) {\n      if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).is(event.target) && !jquery__WEBPACK_IMPORTED_MODULE_0___default()('.link').is(event.target)) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).removeClass('tool-active');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.arrow').removeClass('arrow-block');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.arrowl').removeClass('arrow-block');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).removeClass('tool-activel');\n      }\n    });\n  }\n}\n\nfunction formWarn() {\n  /*$('.button--modal').on('click', function(){\n      let mod = $(this).parent();\n      mod.find('.form__input').each(function(){\n        if ($(this).val() < 2) {\n          $(this).addClass('form__input--warn');\n          $(this).siblings('.text-warn').css('display', 'block');\n          event.preventDefault();\n        }else{\n          $(this).removeClass('form__input--warn');\n          $(this).siblings('.text-warn').css('display', 'none');\n        }\n      });\n    });*/\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('click', function (event) {\n    if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button--modal').is(event.target)) {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.form__input').removeClass('form__input--warn');\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.form__input').siblings('.text-warn').css('display', 'none');\n    }\n  });\n}\n\nfunction anchor() {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll', function () {\n    var $sections = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.section');\n    $sections.each(function (i, el) {\n      var top = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).offset().top - 600;\n      var bottom = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).offset().top + jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).height();\n      var scroll = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop();\n      var id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el).attr('id');\n\n      if (scroll > top && scroll < bottom) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('a.nav-active').removeClass('nav-active');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('a[href = \"#' + id + '\"]').addClass('nav-active');\n      }\n\n      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() == 0) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('a.nav-active').removeClass('nav-active');\n      }\n    });\n  });\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"nav\").on(\"click\", \"a\", function (event) {\n    event.preventDefault();\n    var id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href'),\n        top = jquery__WEBPACK_IMPORTED_MODULE_0___default()(id).offset().top - 100;\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body,html').animate({\n      scrollTop: top\n    }, 400);\n  });\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.logo').on('click', function (event) {\n    event.preventDefault();\n    var id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href'),\n        top = jquery__WEBPACK_IMPORTED_MODULE_0___default()(id).offset().top - 100;\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body,html').animate({\n      scrollTop: top\n    }, 400);\n  });\n}\n\nfunction formId() {\n  var data;\n  var modal;\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button').on('click', function () {\n    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).is('[data-form-id]')) {\n      data = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data-form-id');\n      modal = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href');\n    }\n\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(modal).find('[name=\"form-id\"]').val(data);\n  });\n}\n\nfunction ajaxForms(data) {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({\n    type: \"POST\",\n    url: \"/backend/mail.php\",\n    dataType: 'json',\n    data: data,\n    success: function success(data) {\n      if (data.success == true) {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__thanks').css('display', 'flex');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal-form__consent').removeClass('modal-form__consent--red');\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consent-checkbox').removeClass('consent-checkbox--red');\n      }\n    }\n  });\n}\n\n//# sourceURL=webpack:///./app/scripts/index.js?");
